...
export default class Salle11 extends Phaser.Scene {
  // constructeur de la classe
  constructor() {
    super({
      key: "Salle11" //  ici on précise le nom de la classe en tant qu'identifiant
    });
  }
  preload() {
    ...
    this.load.tilemapTiledJSON("carte11", "src/assets/Salle01.tmj");
  ...
  create() {
    ...
    const map = this.add.tilemap( "carte11" );
  ...
  update() {
    ...
    if (open_porte1 == false && Phaser.Input.Keyboard.JustDown(interact) == true &&
      ...
      this.time.delayedCall(500, () => {
        ...
        this.scene.start("Couloir3", { x: 3520, y: 800 });
      });
