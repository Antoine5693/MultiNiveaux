...
export default class Salle06 extends Phaser.Scene {
  ...
  constructor() {
    super({
      key: "Salle06" //  ici on précise le nom de la classe en tant qu'identifiant
    });
  }
  preload() {
    ...
    this.load.tilemapTiledJSON("carte06", "src/assets/Salle01.tmj");
  ...
  create() {
    ...
    const map = this.add.tilemap( "carte06" );
