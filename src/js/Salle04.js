...
export default class Salle04 extends Phaser.Scene {
  // constructeur de la classe
  constructor() {
    super({
      key: "Salle04" //  ici on précise le nom de la classe en tant qu'identifiant
    });
  }
  preload() {
    ...
    this.load.tilemapTiledJSON("carte04", "src/assets/Salle01.tmj");
  ...
  create() {
    ...
    const map = this.add.tilemap( "carte04" );
  ...
  update() {
    ...
    if (open_porte1 == false && Phaser.Input.Keyboard.JustDown(interact) == true &&
      ...
      this.time.delayedCall(500, () => {
        ...
        this.scene.start("Couloir1", { x: 2848, y: 1248 });
      });
