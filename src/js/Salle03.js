...
export default class Salle03 extends Phaser.Scene {
  // constructeur de la classe
  constructor() {
    super({
      key: "Salle03" //  ici on précise le nom de la classe en tant qu'identifiant
    });
  }
  preload() {
    ...
    this.load.tilemapTiledJSON("carte03", "src/assets/Salle01.tmj");
...
interact = this.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.ENTER);
    ...
    const map = this.add.tilemap( "carte03" );
