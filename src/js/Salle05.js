...
export default class Salle05 extends Phaser.Scene {
  ...
  constructor() {
    super({
      key: "Salle05" //  ici on précise le nom de la classe en tant qu'identifiant
    });
  }
  preload() {
    ...
    this.load.tilemapTiledJSON("carte05", "src/assets/Salle01.tmj");
  }
  ...
  create() {
    ...
    const map = this.add.tilemap( "carte05" );
