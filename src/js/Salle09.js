...
export default class Salle09 extends Phaser.Scene {
  // constructeur de la classe
  constructor() {
    super({
      key: "Salle09" //  ici on précise le nom de la classe en tant qu'identifiant
    });
  }
  preload() {
  ...
  update() {
    ...
    if (open_porte1 == false && Phaser.Input.Keyboard.JustDown(interact) == true &&
      ...
      this.time.delayedCall(500, () => {
        ...
        this.scene.start("Couloir2", { x: 2368, y: 416 });
      });
