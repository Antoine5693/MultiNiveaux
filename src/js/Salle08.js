...
export default class Salle08 extends Phaser.Scene {
  ...
  constructor() {
    super({
      key: "Salle08" //  ici on précise le nom de la classe en tant qu'identifiant
    });
  }
  preload() {
    ...
    this.load.tilemapTiledJSON("carte08", "src/assets/Salle01.tmj");
  }
  ...
  create() {
    ...
    const map = this.add.tilemap( "carte08" );
