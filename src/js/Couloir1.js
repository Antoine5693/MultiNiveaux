...
export default class Couloir1 extends Phaser.Scene {
  ...
  preload() {
    ...
    // Portes
    this.load.spritesheet("img_porteC1_1", "src/assets/porte1finie.png", { frameWidth: 103, frameHeight: 128 });
    this.load.spritesheet("img_porteC1_2", "src/assets/porte1finie.png", { frameWidth: 103, frameHeight: 128 });
    this.load.spritesheet("img_porteC1_3", "src/assets/porte1finie.png", { frameWidth: 103, frameHeight: 128 });
    this.load.spritesheet("img_porteC1_4", "src/assets/porte1finie.png", { frameWidth: 103, frameHeight: 128 });
    this.load.spritesheet("img_porteC1_5", "src/assets/porte1finie.png", { frameWidth: 103, frameHeight: 128 });
    this.load.spritesheet("img_porteC1_6", "src/assets/porte1finie.png", { frameWidth: 103, frameHeight: 128 });

    // Escaliers
    this.load.image("img_escalier1", "src/assets/escalier.png", { frameWidth: 50, frameHeight: 200 });
    this.load.image("img_escalier2", "src/assets/escalier.png", { frameWidth: 50, frameHeight: 200 });
  ...
  create() {
    ...
    escalier2.setSize(escalier2.width, escalier2.height - 150); // hitbox physique réduite
    this.zone_escalier2 = this.add.zone(escalier2.x, escalier2.y, escalier2.width, escalier2.height); // zone de détection
    this.physics.add.existing(this.zone_escalier2, true);
    ...
    porte6.setSize(103, 64);
    porte6.setOffset(0, 0);
    this.physics.add.collider(player, porte6);

    // ---- COLLIDERS ESCALIERS ----
    this.physics.add.collider(player, escalier1);
    this.physics.add.collider(player, escalier2);
  }
